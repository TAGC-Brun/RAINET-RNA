...
# #
# This class describes a annotation of protein on Corum clusters
#
class ProteinCorumAnnotation( Base ):
    __tablename__ = 'ProteinCorumAnnotation'
    
    # The Corum cluster annotation
    Corum_cluster_id = Column( String, ForeignKey( 'CorumCluster.clusterID', onupdate="CASCADE", ondelete="CASCADE"), primary_key=True)
    ...
    #
    # @param Corum_cluster_id : string - The ID of the Corum cluster associated to the protein
