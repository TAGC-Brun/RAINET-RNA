...
#expression_sample_input_file = "/home/diogo/workspace/tagc-rainet-RNA/src/fr/tagc/rainet/core/execution/processing/expressionData/dataFiles/expression_sample.csv"
...
print("ALL SAMPLES: summary(expression_df$value[expression_df$variable == Brain]")
