...
# like insertion.ini file that contains list of files used for data insertion.
#
            ...
            for option in options:
                try:
                    ...
                    if self.propertiesDict[option] == None:
                        raise RainetException( "PropertyManager.readProperties : Wrong property definition for key = " + option + " in section " + section + " of file " + file_path)
                except:
                    raise RainetException( "PropertyManager.readProperties : Abnormal property definition for key = " + option + " in section " + section + " of file " + file_path)
